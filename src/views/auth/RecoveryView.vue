      ...
      >
        ...
        <div v-if="emailTab" class="area-login px-4">
          ...
          <div class="mt-4">
            ...
            />
            <p v-if="msgSuccessEmail" class="text-success mt-2">
              <i class="fa fa-check"></i> Este e-mail está em nossa base de
              dados.
            </p>
            <p v-if="msgErrorEmail" class="text-danger mt-2">
              <i class="fa fa-ban"></i> Este e-mail não está em nossa base de
              dados, tente outro. tenho outro.
            </p>
          </div>
          ...
          <div class="row mt-5">
            ...
            <div class="col-1">
              ...
              <input
                type="text"
                v-if="!mostrarSkeleton"
                class="form-control number-code-input"
                v-model="number1"
                placeholder="0"
                maxlength="1"
              />
            ...
            <div class="col-12">
              <p v-if="msgSuccessCode" class="text-success mt-4 text-center">
                <i class="fa fa-check"></i> Código confirmado
              </p>
              <p v-if="msgErrorCode" class="text-danger mt-4 text-center">
                <i class="fa fa-ban"></i> Código não confere
              </p>
            </div>
          </div>
        ...
        <div v-if="passwordTab" class="area-login px-4">
          ...
          <div v-if="mostrarSkeleton" class="skeleton-title-subtitle"></div>
          <p v-if="!mostrarSkeleton">
            Digite novas senhas e anote em um lugar seguro.
          </p>

          <p v-if="msgSuccessNewPass" class="text-success mt-2">
      ...
      <div class="col-lg-6 p-0 d-none d-lg-block">
        <div class="bg-login">
          <div class="gradient px-5">
            <img
              src="../../../assets/images/logo-transparente2.png"
              class="img-fluid"
              alt=""
            />
          </div>
