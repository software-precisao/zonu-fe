          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <p v-if="msgErrorSenha" class="text-danger mt-2">
                  <small
                    ><i class="fa fa-ban"></i> As senhas não conferem</small
                  >
                </p>
                <p v-if="msgSuccessSenha" class="text-success mt-2">
                  <small><i class="fa fa-check"></i> As senhas conferem</small>
                </p>
              </div>
            </div>
          </div>
