    ...
    <div class="row">
      <div class="col-lg-6 d-flex flex-column justify-content-center align-items-center p-5">
        ...
        <div v-if="cnpjTab" class="area-login px-4">
          ...
          <div class="card mt-3" v-if="!mostrarSkeleton" href="/cadastro"
            style="height: 150px; width: 150px; margin-left: auto; margin-right: auto; display: block;">
            <div class="card-body">
              <img src="../../../assets/images/iconImobiliaria.svg"
        ...
        <div v-if="dadosTab" class="">
          ...
          <div v-if="mostrarSkeleton" class="skeleton-title-subtitle"></div>
          <p v-if="!mostrarSkeleton">
            Agora preencha esses dados para entrar na sua plataforma.
          </p>
          ...
          <p v-if="msgCnpjActive" class="text-danger mt-2">
            <i class="fa fa-circle-exclamation"></i> Desculpe, mas já temos esse
...
import imobiliariaApi from "../../../service/api/auth/index";
export default {
  name: "CadastroView",
  data() {
    return {
  ...
  methods: {
    ...
    handleValidar() {
      ...
      if (
        ...
        imobiliariaApi.cadastroImobiliaria(
          nome,
          sobrenome,
          email,
          senha,
