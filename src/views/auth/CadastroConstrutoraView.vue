    ...
    <div class="row">
      <div class="col-lg-6 d-flex flex-column justify-content-center align-items-center p-5">
        ...
        <div v-if="cnpjTab" class="area-login px-4">
          ...
          <div v-if="!mostrarSkeleton" class="card mt-3" href="/cadastro" style="height: 150px; width: 150px; margin-left: auto; margin-right: auto; display: block;">
            <div class="card-body">
