        ...
        <div class="row">
            <div class="col-lg-6 d-flex flex-column justify-content-center align-items-center p-5">
                ...
                <div class="area-login px-4">
                    ...
                    <div v-if="!mostrarSkeleton" class="card mt-3" href="/cadastro"
                    ...
                    <div class="area-dados-corretor px-2">
                        <div class="mt-2">
                            <div class="mb-3">
                                ...
                                <input type="text" placeholder="000.000.000-00" v-if="!mostrarSkeleton"
                                    class="form-control" v-model="cpf" @input="aplicaMascaraCPF" />
                            </div>
                        </div>
