        ...
        <div class="row">
          ...
          <div class="col-4">
            <div class="d-grid gap-2">
              <button @click="handleAvancar()" class="btn btn-warning btn-start" type="button">
                <span style="font-weight: 300; font-size: 20px">Cadastrar meu primeiro imóvel</span>
              </button>
            </div>
          </div>
          <div class="col-4"></div>
                  ...
                  <div class="w-100">
                    <div class="row">
                      <div class="card" v-if="infoTab">
                        <div class="card-body">
                          <div class="col mt-0">
                            <h1 class="title-login mt-2" style="text-align: left; color: #d7d7d7">
                            ...
                            <div class="row mt-4">
                              ...
                              <div class="col-3">
                                <div class="mb-3">
                                  <div v-if="mostrarSkeleton" class="skeleton-label"></div>
                                  <div v-if="mostrarSkeleton" class="skeleton-input"></div>
                                  <label v-if="!mostrarSkeleton" for="exampleInputEmail1" class="form-label">Possui box
                                    na garagem?
                                  </label>
                            ...
                            <div class="row mt-4">
                              ...
                              <div class="col-4">
                                <div class="mb-3">
                                  ...
                                  <div class="input-group">
                                    <input type="text" required v-if="!mostrarSkeleton" class="form-control"
                                      v-model="areaPrivativa" placeholder="0,00" @input="
                      ...
                      <div class="card" v-if="addCaracteristicas">
                        <div class="card-body">
                          <div class="col mt-0">
                            ...
                            <p>
                              Quais as características que este imóvel tem?.
                            </p>
                          </div>
                          <div>
                            <div class="row mt-4">
                              <div class="col-12">
                                <div v-if="msgSuccessCaracteristica"
                                ...
                                <div class="mb-3">
                                  ...
                                  <label v-if="!mostrarSkeleton" for="exampleInputEmail1"
                                    class="form-label">Caracteristica
                                    <small class="text-danger">*</small>
                                  </label>
                                  <input type="text" required v-if="!mostrarSkeleton" class="form-control"
                                    v-model="inputCaracteristicas" placeholder="Digite aqui..." />
                                </div>
                            ...
                            <div class="row mt-3">
                              <div class="col-md-6">
                                <div class="d-grid gap-2 d-md-block">
                                  <button @click="handleFecharCaracteristicas()" class="btn btn-secondary"
                                    type="submit">
                        ...
                        <div class="card-body">
                          <div class="col mt-0">
                            <h1 class="title-login mt-2">
                              ...
                              <span style="float: inline-end"><button @click="handleAbrirCaracteristicas()"
                        ...
                        <div class="card-body">
                          ...
                          <div>
                                ...
                                <div class="mb-3">
                                  ...
                                  <div class="input-group">
                                    <input type="text" @input="aplicaMascaraCEP" class="form-control"
                                      placeholder="00000-00" v-model="buscarCEP" required v-if="!mostrarSkeleton"
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-12" v-if="mostrarStreetV">
                                    <div class="col-12 mb-3">
                                      <small>* As imagens são extraídas do google e
                            ...
                            <div class="row mt-3">
                              <div class="col-md-6">
                                <div class="d-grid gap-2 d-md-block">
                                  <button @click="handleAnteriorCaracteristica()" class="btn btn-secondary"
                                    type="button">
                                    <i class="fa fa-arrow-left" aria-hidden="true"></i>
                                    Anterior
                                  </button>
                      ...
                      <div class="card" v-if="addProximidades">
                        <div class="card-body">
                          ...
                          <div>
                            <div class="row mt-4">
                              <div class="col-12">
                                <div v-if="msgSuccessProximidade"
                                  class="alert alert-success alert-dismissible fade show" role="alert">
                                  <strong><i class="fa fa-check"></i>
                                    Sucesso!</strong>
                                ...
                                <div class="mb-3">
                                  ...
                                  <label v-if="!mostrarSkeleton" for="exampleInputEmail1"
                                    class="form-label">Proximidades
                                    <small class="text-danger">*</small>
                                  </label>
                                  <input type="text" required v-if="!mostrarSkeleton" class="form-control"
                                    v-model="inputProximidades" placeholder="Digite aqui..." />
                                </div>
                      ...
                      <div class="card" v-if="proximidadesTab">
                        <div class="card-body">
                          <div class="col mt-0">
                            <h1 class="title-login mt-2">
                              ...
                              <span style="float: inline-end">
                                <button @click="handleAbrirProximidades()" type="button" class="btn btn-success btn-sm">
                                  <i class="fa fa-plus"></i> Adicionar
                                  Proximidades
                                </button>
                              </span>
                          ...
                          <div>
                            <div class="row">
                              <div class="col-md-4" v-for="proximidade in minhasProximidades"
                              ...
                              <div class="col-md-6" v-for="item in listProximidades" :key="item.id_proximidade">
                                <div class="form-check">
                      ...
                      <div class="card" v-if="imagemTab">
                        <div class="card-body">
                          <div class="col mt-0">
                            ...
                            <p>
                              Envie todas as imagens que mostrem as qualidades
                              do imóvel.
                            </p>
                          </div>
                          <div>
                              ...
                              <div class="col-3">
                                <div class="mb-3">
                                  ...
                                  <label v-if="!mostrarSkeleton" for="exampleInputEmail1" class="form-label">
                                    ...
                                    <p>
                                      <small>Determine se o imóvel será publicado em
                                        seu site.</small>
                                    </p>
                                  </label>
                            ...
                            <div class="row mt-3">
                              ...
                              <div class="col-md-6">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                  ...
                                  <div class="modal fade" style="z-index: 1060 !important" id="exampleModalss"
                                        ...
                                        <div class="modal-body">
                                          <div v-if="msgError" class="alert alert-danger mt-4 mb-4" style="
                                            ...
                                            <strong><i class="fa fa-ban"></i>
                                              Desculpa, houve um erro para
                                              processar o seu pedido. Tente
                                              novamente mais tarde</strong>
                                          </div>
                                          ...
                                          <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                              <button class="nav-link" id="comodos-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="comodos-tab-pane" aria-selected="false">
                                                <small>Cômodos</small>
                                              </button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                              <button class="nav-link" id="comodos-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="medidas-tab-pane" aria-selected="false">
                                            ...
                                            <li class="nav-item" role="presentation">
                                              <button class="nav-link" id="descricao-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="descricao-tab-pane" aria-selected="false">
                                            ...
                                            <li class="nav-item" role="presentation">
                                              <button class="nav-link" id="publicar-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="publicar-tab-pane" aria-selected="false">
                                          ...
                                          <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="row mt-4">
                                                  <div class="col-3">
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="mostrarSkeleton" class="skeleton-input"></div>
                                                      <label v-if="!mostrarSkeleton" for="exampleInputEmail1"
                                                        class="form-label">Código de referência
                                                        <small class="text-danger">*</small>
                                                      </label>
                                                      <input type="text" required v-if="!mostrarSkeleton"
                                                        class="form-control" v-model="codigoref"
                                                        placeholder="Digite aqui..." />

                                                      <small v-if="msgNull" class="text-danger">
                                                        <li class="mt-2">
                                                          Não deixe este campo
                                                          vazio
                                                        </li>
                                                      </small>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="selectCondominio"
                                                          id="selectCondominio1" autocomplete="off" value="Sim" v-model="selectCondominio
                                                            " />
                                                  ...
                                                  <div class="col-6">
                                                    <div class="mb-3">
                                                      ...
                                                      <select required v-if="!mostrarSkeleton"
                                                        class="form-control form-select" v-model="condominioEmpreendimento
                                                          ">
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" id="btnTerreno1"
                                                          autocomplete="off" value="Plano" name="selectTerreno" v-model="selectTerreno
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                  ...
                                                  <div class="col-3">
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="mostrarSkeleton" class="skeleton-input"></div>
                                                      <label v-if="!mostrarSkeleton" for="exampleInputEmail1"
                                                        class="form-label">Próximo ao mar?<small class="text-danger">*
                                                        </small>
                                                      </label>
                                                      <select type="text" required v-if="!mostrarSkeleton"
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="selectAverbado"
                                                          id="selectAverbado1" autocomplete="off" value="Sim" v-model="selectAverbado
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="selectEscritura"
                                                          id="selectEscritura1" autocomplete="off" value="Sim" v-model="selectEscritura
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="selectEsquina"
                                                          id="selectEsquina1" autocomplete="off" value="Sim" v-model="selectEsquina
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="selectMobilia"
                                                          id="selectMobilia1" autocomplete="off" value="Sim" v-model="selectMobilia
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                ...
                                                <div class="row mt-4">
                                                  ...
                                                  <div class="col-3">
                                                    <div class="mb-3">
                                                      ...
                                                      <div class="btn-group" role="group"
                                                        ...
                                                        <input v-if="
                                                          !mostrarSkeleton
                                                        " type="radio" class="btn-check" name="garagemCoberta"
                                                          id="selectGaragemCobertura1" autocomplete="off" value="Sim"
                                                          v-model="selectGaragemCobertura
                                                            " />
                                                        <label v-if="
                                                  ...
                                                  <div class="col-3">
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="mostrarSkeleton" class="skeleton-input"></div>
                                                      <label v-if="!mostrarSkeleton" for="exampleInputEmail1"
                                                        class="form-label">Possui box na garagem?
                                                      </label>
                                                      ...
                                                      <div class="btn-group" role="group"
                                                        ...
                                                        <input v-if="
                                                          !mostrarSkeleton
                                                        " type="radio" class="btn-check" name="boxGaragem"
                                                          id="boxGaragemY" autocomplete="off" value="Sim" v-model="selectBoxGaragem
                                                            " />
                                                        <label v-if="
                                                          !mostrarSkeleton
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="estaFinanciado"
                                                          id="estaFinanciado1" autocomplete="off" value="Sim" v-model="estaFinanciado
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="aceitaPermuta"
                                                          id="aceitaPermuta1" autocomplete="off" value="Sim" v-model="aceitaPermuta
                                                            " />
                                                        <label class="btn btn-outline-success"
                                            ...
                                            <div class="tab-pane fade" id="caracteristica-tab-pane" role="tabpanel"
                                              ...
                                              <div>
                                                <div class="row mt-3">
                                                  <div class="col-md-6">
                                                    <div class="form-check"
                                                      v-for="caracteristica in minhasCaracteristicas" :key="caracteristica.id_caracteristica
                                                        ">
                                                      <input v-if="!mostrarSkeleton" class="form-check-input" v-model="caracteristicaImovel[
                                                        caracteristica
                                                          .id_caracteristica
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div class="input-group">
                                                        <input type="text" @input="aplicaMascaraCEP
                                                          ...
                                                          v-model="buscarCEP" required v-if="
                                                            !mostrarSkeleton
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="mostrarNUnidade"
                                                          id="mostrarNUnidade1" autocomplete="off" value="Sim" v-model="mostrarNUnidade
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="mostrarBairro"
                                                          id="mostrarBairro1" autocomplete="off" value="Sim" v-model="mostrarBairro
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="mostrarNumero"
                                                          id="mostrarNumero1" autocomplete="off" value="Sim" v-model="mostrarNumero
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                    ...
                                                    <div class="mb-3">
                                                      ...
                                                      <div class="btn-group" role="group"
                                                        ...
                                                        <input type="radio" class="btn-check" name="mostrarNCondo"
                                                          id="mostrarNCondo1" autocomplete="off" value="Sim" v-model="mostrarNCondo
                                                            " />
                                                        <label class="btn btn-outline-success"
                                                          for="mostrarNCondo1">Sim</label>

                                                        <input type="radio" class="btn-check" value="Não" v-model="mostrarNCondo
                                                          " name="mostrarNCondo" id="mostrarNCondo2"
                                                          autocomplete="off" />
                                                        <label class="btn btn-outline-danger"
                                                        ...
                                                        <div class="mb-3">
                                                          ...
                                                          <div class="btn-group" role="group"
                                                            ...
                                                            <input type="radio" class="btn-check" name="mapaStreetV"
                                                              id="mapaStreetV1" autocomplete="off" value="Sim" v-model="mapaStreetV
                                                                " />
                                                            <label class="btn btn-outline-success"
                                                ...
                                                <div class="row mt-4">
                                                  <div class="col-12">
                                                    <div class="mb-3">
                                                      ...
                                                      <label v-if="!mostrarSkeleton" for="exampleInputEmail1"
                                                        class="form-label">
                                                        Vídeo do Imóvel: Insira
                                                        a URL do seu vídeo no
                                                        Youtube
                                                        <button type="button" class="btn btn-danger ms-2" style="
                                                            --bs-btn-padding-y: 0.25rem;
                                                            --bs-btn-padding-x: 0.5rem;
                                            ...
                                            <div class="tab-pane fade" id="images-tab-pane" role="tabpanel"
                                              ...
                                              <div>
                                                <div class="row mt-4">
                                                  ...
                                                  <li class="text-danger">
                                                    <small>
                                                      Tamanho máx. permitido é
                                                      de até 3 mb por
                                                      imagem.</small>
                                                  </li>
                                                  <li class="text-danger">
                                                    <small>
                                                      A resolução ideal de w:
                                                      1342 h:768.</small>
                                                  </li>
                                            ...
                                            <div class="tab-pane fade" id="publicar-tab-pane" role="tabpanel"
                                              ...
                                              <div class="row mt-4">
                                                <div class="col-3">
                                                  <div class="mb-3">
                                                    ...
                                                    <label v-if="!mostrarSkeleton" for="exampleInputEmail1"
                                                      ...
                                                      Mostrar imóvel no site?
                                                      <p>
                                                        <small>Determine se o imóvel
                                                          será publicado em seu
                                                          site.</small>
                                                      </p>
                                                    </label>
                                                    ...
                                                    <div class="btn-group" role="group"
                                                      ...
                                                      <input type="radio" class="btn-check" name="selectImovelSite"
                                                        id="selectImovelSite1" autocomplete="off" value="Sim" v-model="selectImovelSite
                                                          " />
                                                      <label class="btn btn-outline-success"
                                                        for="selectImovelSite1">Sim</label>

                                                      <input type="radio" class="btn-check" value="Não" v-model="selectImovelSite
                                                        " name="selectImovelSite" id="selectImovelSite2"
                                                        autocomplete="off" />
                                                      <label class="btn btn-outline-danger"
                                                ...
                                                <div class="col-6">
                                                  <label class="form-label mb-3" for="btnradio2">
                                                    Tarja do imóvel para o site
                                                    <br />
                                                    <small>Escolha a cor e a frase
                                                      que aparecerão na
                                                      miniatura do imóvel.
                                                    </small>
                                                  </label>
                                                  <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                      <div class="mb-3">
                                                        ...
                                                        <input type="color" v-if="
                                                          !mostrarSkeleton
                                                        " v-model="corTarja" class="form-control"
