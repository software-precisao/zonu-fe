            ...
            <div class="d-grid gap-2">
              ...
              >
                <span style="font-weight: 300; font-size: 20px"
                  >Cadastrar meu primeiro imóvel</span
                >
              </button>
            </div>
          </div>
                        ...
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="row align-items-center">
                              ...
                              <div class="col-12">
                                <span v-if="!stepComodos"
                                  ><i class="fa fa-circle"></i> Cômodos</span
                                >
                    ...
                    <div class="row">
                      <div class="card" v-if="infoTab">
                        <div class="card-body">
                          <div class="col mt-0">
                            <h1
                              class="title-login mt-2"
                              style="text-align: left; color: #d7d7d7"
                            >
                            ...
                            <div class="row mt-4">
                              <div class="col-3">
                                ...
                                <p v-if="msgNullComodos" class="text-danger">
                                  <small
                                    ><i class="fa fa-ban"></i> Não deixe este
                                    campo vazio!</small
                                  >
                                </p>
                              </div>
                            ...
                            <div class="row mt-3">
                              ...
                              <div class="col-md-6">
                                ...
                                >
                                  <button
                                    class="btn btn-success"
                                    @click="handleProximoCaracteristica()"
                                    type="button"
                                  >
                                    Próximo
                                    <i
                          ...
                          <div>
                              ...
                              <div class="col-12">
                                ...
                                <div class="mb-3">
                                  ...
                                  <input
                                    ...
                                    v-if="!mostrarSkeleton"
                                    class="form-control"
                                    v-model="inputCaracteristicas"
                                    placeholder="Digite aqui..."
                                  />
                                </div>
                                <p
                                  v-if="msgNullCaracteristica"
                                  class="text-danger"
                                >
                                  <small
                                    ><i class="fa fa-ban"></i> Não deixe este
                            ...
                            <div class="row mt-3">
                              <div class="col-md-6">
                                <div class="d-grid gap-2 d-md-block">
                                  <button
                                    @click="handleFecharCaracteristicas()"
                                    class="btn btn-secondary"
                                    type="submit"
                                  >
                                    <i
                              ...
                              <div class="col-md-6">
                                ...
                                >
                                  <button
                                    class="btn btn-success"
                                    @click="handleSaveCaracteristicas()"
                                    type="button"
                                  >
                                    Salvar
                                  </button>
                          ...
                          <div class="col mt-0">
                            <h1 class="title-login mt-2">
                              ...
                              <span style="float: inline-end"
                                ><button
                                  @click="handleAbrirCaracteristicas()"
                                  type="button"
                                ...
                                >
                                  <div class="form-check">
                                    ...
                                    <label
                                      ...
                                      class="form-check-label"
                                      :for="
                                        'flexCheck' + item.id_caracteristica
                                      "
                                    >
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-12" v-if="mostrarStreetV">
                                    <div class="col-12 mb-3">
                                      <small
                                        >* As imagens são extraídas do google e
                                      ...
                                      <div class="mb-3">
                                        ...
                                        >
                                          <input
                                            type="radio"
                                            class="btn-check"
                                            name="selectStreetVSite"
                                            id="selectStreetVSite1"
                                            autocomplete="off"
                                            value="Sim"
                                          ...
                                          <input
                                            ...
                                            v-model="selectStreetVSite"
                                            name="selectStreetVSite"
                                            id="selectStreetVSite2"
                                            autocomplete="off"
                                          />
                                          <label
                                            class="btn btn-outline-danger"
                                            for="selectStreetVSite2"
                                            >Não</label
                                          >
                                        </div>
                                      </div>
                          ...
                          <div>
                              ...
                              <div class="col-12">
                                ...
                                <div class="mb-3">
                                  ...
                                  <input
                                    ...
                                    v-if="!mostrarSkeleton"
                                    class="form-control"
                                    v-model="inputProximidades"
                                    placeholder="Digite aqui..."
                                  />
                                </div>
                                <p
                                  v-if="msgNullProximidades"
                                  class="text-danger"
                                >
                                  <small
                                    ><i class="fa fa-ban"></i> Não deixe este
                            ...
                            <div class="row mt-3">
                              <div class="col-md-6">
                                <div class="d-grid gap-2 d-md-block">
                                  <button
                                    @click="handleFecharProximidades()"
                                    class="btn btn-secondary"
                                    type="submit"
                                  >
                                    <i
                        ...
                        <div class="card-body">
                          ...
                          <div>
                            <div class="row">
                              <div
                                class="col-md-4"
                                v-for="proximidade in minhasProximidades"
                              ...
                              >
                                ...
                                >
                                  <input
                                    ...
                                    type="checkbox"
                                    :id="
                                      'flexCheck' + proximidade.id_proximidade
                                    "
                                    style="margin-right: 10px"
                                  />
                                  <label
                          ...
                          <div>
                            ...
                            <div class="row mt-3">
                              <div class="col-md-6">
                                <div class="d-grid gap-2 d-md-block">
                                  <button
                                    @click="handleAnteriorProximidade()"
                                    class="btn btn-secondary"
                                    type="button"
                                  >
                                    <i
                          ...
                          <div>
                            ...
                            <div class="row mt-3">
                              <div class="col-md-6">
                                <div class="d-grid gap-2 d-md-block">
                                  <button
                                    @click="handleAnteriorComplemento()"
                                    class="btn btn-secondary"
                                    type="button"
                                  >
                                    <i
                            ...
                            <div class="row mt-4">
                              <div class="col-3">
                                <div class="mb-3">
                                  ...
                                  >
                                    ...
                                    <p>
                                      <small
                                        >Determine se o imóvel será publicado em
                                        seu site.</small
                                      >
                                    </p>
                                  </label>
                              ...
                              <div class="col-6">
                                <label class="form-label mb-3" for="btnradio2">
                                  ...
                                  <small
                                    >Escolha a cor e a frase que aparecerão na
                                    miniatura do imóvel.
                                  </small>
                                </label>
                                <div class="row">
