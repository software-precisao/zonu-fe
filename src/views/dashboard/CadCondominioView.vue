                          ...
                          <div class="row mt-4">
                            <div class="col-12">
                              <div class="mb-3">
                                ...
                                <input type="text" required class="form-control" v-model="condNome"
                                  placeholder="Digite..." />
                              </div>
                            </div>
                            ...
                            <div class="col-md-12">
                              <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button class="btn btn-success" @click="handleSalvar()" type="button">
                                  Salvar
                                </button>
                              </div>
                            </div>
                            ...
                            <div class="col-12">
                              <div class="mb-3">
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    <tr v-for="item in listsCondominios" :key="item.id_condominio">
                                ...
                                <div class="d-grid mt-3 mb-3 gap-2 d-md-flex justify-content-md-end">
                                  ...
                                  <button class="btn btn-dark btn-sm" style="margin-right: 3% !important"
                                    @click="nextPageCondominio()" :disabled="currentPageCondominio >=
  ...
  methods: {
    ...
    fetchList() {
      ...
      api.listcondominio(id_user).then((res) => {
        ...
        // Filtrar condomínios removendo aqueles com campos nulos
        let condominiosFiltrados = condominios.filter((condominio) => {
          return condominio.id_condominio !== null &&
            condominio.nome_condominio !== null
        });

        this.listsCondominios = condominiosFiltrados;
