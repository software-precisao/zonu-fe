                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        >
                          ...
                          Proximidade excluída com sucesso.
                        </div>
                        <div>
                          <div class="row mt-4">
                            <div class="col-12">
                              <div class="mb-3">
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    <tr
                                      v-for="item in ProximidadeOnCurrentPage"
                                    ...
                                    >
                                      ...
                                      <td>
                                        <button
                                          @click="
                                            handleDelete(item.id_proximidade)
                                          "
                                          type="button"
...
export default {
  ...
  computed: {
    ProximidadeOnCurrentPage() {
      const startIndex =
        (this.currentPageProximidade - 1) * this.perPageProximidade;
