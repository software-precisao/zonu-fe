          ...
          <div class="row">
              ...
              <div class="card mb-3">
                <div class="card-header">
                  <h5 class="card-title mb-0">
                    <i class="fa fa-tag"></i> Abra um novo Ticket
                  </h5>
                </div>
                <div class="card-body">
                  <div
                    ...
                    <div class="row">
                      <div class="col-5">
                        <div class="form-group">
                          <label for=""
                            ><small><strong>Assunto</strong></small></label
                          >
                          <select
            ...
            <div class="col-md-12 col-xl-12">
              <div class="card mb-3">
                <div class="card-header">
                  <h5 class="card-title mb-0">
                    <i class="fa fa-tag"></i> Seus Tickets abertos
                  </h5>
                </div>
                <div class="card-body">
                  <div
                  ...
                  <div
                    ...
                    role="alert"
                  >
                    <i class="fa fa-check"></i> Ticket Excluído com sucesso!
                  </div>
                  <div class="container">
                    <div class="row">
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          >
                            ...
                            <td v-if="ticket.tempo_resposta !== null">
                              <i class="fa fa-clock"></i>
                              {{ ticket.tempo_resposta }} Segundos
                            </td>
