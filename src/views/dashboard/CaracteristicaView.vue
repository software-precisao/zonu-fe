                            ...
                            <div class="col-12">
                              <div class="mb-3">
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    <tr
                                      v-for="item in CaracteristicaOnCurrentPage"
                                    ...
                                    >
                                      ...
                                      <td>
                                        <button
                                          @click="
                                            handleDelete(item.id_caracteristica)
                                          "
                                          type="button"
...
export default {
  ...
  computed: {
    CaracteristicaOnCurrentPage() {
      const startIndex =
        (this.currentPageCaracteristica - 1) * this.perPageCaracteristica;
