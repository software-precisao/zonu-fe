                    ...
                    <div class="card" v-if="addProximidades">
                      <div class="card-body">
                        ...
                        <div>
                          <div class="row mt-4">
                            <div class="col-12">
                              <div v-if="msgSuccessProximidade" class="alert alert-success alert-dismissible fade show"
                                role="alert">
                                <strong><i class="fa fa-check"></i> Sucesso!</strong>
                      ...
                      <div class="card-body">
                        ...
                        <div>
                          <div class="row">
                            ...
                            <div class="col-md-4" v-for="item in listProximidades" :key="item.id_proximidade">
                              <div class="form-check d-flex align-items-center" style="margin-bottom: 10px">
                                <input v-if="!mostrarSkeleton" class="form-check-input" v-model="proximidadesAllImovel[item.id_proximidade]
                                  ...
                                  style="margin-right: 10px" />
                                <label v-if="!mostrarSkeleton" class="form-check-label"
                                  :for="'flexCheck' + item.id_proximidade" style="flex-grow: 1; margin-right: 10px">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div v-if="msgError" class="alert alert-danger mt-4 mb-4" style="
                                            ...
                                            margin-bottom: 10px;
                                          " role="alert">
                                          <strong><i class="fa fa-ban"></i> Desculpa,
                                            houve um erro para processar o seu
                                            pedido. Tente novamente mais
                                            tarde</strong>
                                        </div>
                                                ...
                                                <div class="col-3">
                                                  <div class="mb-3">
                                                    ...
                                                    <div class="btn-group" role="group"
                                                      ...
                                                      <input v-if="!mostrarSkeleton" type="radio" class="btn-check"
                                                        value="Não" v-model="selectBoxGaragem
                                                  ...
                                                  <div class="mb-3">
                                                    ...
                                                    <div class="btn-group" role="group"
                                                      ...
                                                      <input type="radio" class="btn-check" name="mostrarLogradouro"
                                                        id="mostrarLogradouro1" autocomplete="off" value="Sim" v-model="mostrarLogradouro
                                                          " />
                                                      <label class="btn btn-outline-success"
                                                ...
                                                <div class="col-4">
                                                  <div class="mb-3">
                                                    ...
                                                    <div class="btn-group" role="group"
                                                      aria-label="Basic radio toggle button group">
                                                      <input type="radio" class="btn-check" name="mostrarComplemento"
                                                        id="mostrarComplemento1" autocomplete="off" value="Sim" v-model="mostrarComplemento
                                                          " />
                                                      <label class="btn btn-outline-success"
                                                      ...
                                                      <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                          ...
                                                          <input type="radio" class="btn-check" name="selectMapSite"
                                                            id="selectMapSite1" autocomplete="off" value="Sim" v-model="selectMapSite
                                                              " />
                                                          <label class="btn btn-outline-success"
                                              ...
                                              <div class="row mt-4">
                                                ...
                                                <div class="col-12">
                                                  <div class="mb-3">
                                                    ...
                                                    <label v-if="!mostrarSkeleton" for="exampleInputEmail1"
                                                      class="form-label">
                                                      Apresentação 360°: Insira
                                                      a URL 360° do seu imóvel
                                                      <button type="button" class="btn btn-danger ms-2" style="
                                                          --bs-btn-padding-y: 0.25rem;
                                                          --bs-btn-padding-x: 0.5rem;
                                                          --bs-btn-font-size: 0.75rem;
                                          ...
                                          <div class="tab-pane fade" id="images-tab-pane" role="tabpanel"
                                            ...
                                            <div>
                                              <div class="row mt-4">
                                                ...
                                                <li class="text-danger">
                                                  <small>
                                                    Tamanho máx. permitido é de
                                                    até 3 mb por imagem.</small>
                                                </li>
                                                <li class="text-danger">
                                                  <small>
                                                    A resolução ideal de w: 1342
                                                    h:768.</small>
                                                </li>
                                            ...
                                            <div class="row mt-4">
                                              ...
                                              <div class="col-6">
                                                <label class="form-label mb-3" for="btnradio2">
                                                  ...
                                                  <br />
                                                  <small>Escolha a cor e a frase que
                                                    aparecerão na miniatura do
                                                    imóvel.
                                                  </small>
                                                </label>
                                                <div class="row">
