    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col mt-0">
            <h5 class="card-title">
              Construtoras <small class="text-success">Em uso</small>
            </h5>
          </div>
          <div class="col-auto">
            <div class="stat text-primary">
    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col mt-0">
            <h5 class="card-title">
              Usuários <small class="text-warning">Aguardando</small>
            </h5>
          </div>
          <div class="col-auto">
            <div class="stat text-primary">
    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col mt-0">
            <h5 class="card-title">
              Usuários <small class="text-success">Ativos</small>
            </h5>
          </div>
          <div class="col-auto">
            <div class="stat text-primary">
    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col mt-0">
            <h5 class="card-title">
              Tickes <small class="text-warning">Aberto</small>
            </h5>
          </div>
          <div class="col-auto">
            <div class="stat text-primary">
        ...
        <div class="mb-0">
          <span class="text-muted"
            ><small>
              <i class="fa fa-smile-o"></i> Usuários satisfeitos</small
            ></span
          >
          <span class="text-success">
    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col mt-0">
            <h5 class="card-title">
              Tickets <small class="text-success">Resolvidos</small>
            </h5>
          </div>
          <div class="col-auto">
            <div class="stat text-primary">
