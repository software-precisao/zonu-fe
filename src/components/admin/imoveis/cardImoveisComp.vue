    ...
    <div class="card flex-fill w-100">
        <div class="card-header">
            <h5 class="card-title mb-0">
                <i class="fa fa-clock"></i> Ultimos imóveis cadastrados
            </h5>
        </div>
                    ...
                    <div class="col-9" style="margin-left: -10px">
                        <h5>
                            ...
                            <a href="#" style="text-decoration: none; color: #000;" data-bs-toggle="modal"
                                ...
                                <strong>{{ item.descricao.titulo }}</strong>
                            </a>
                            <span class="badge text-bg-success">{{ item.preco.tipo_negocio }}</span>
                        </h5>

                        <!-- Botão de Apagar -->
                        <a data-bs-toggle="modal" :data-bs-target="`#deleteModal${item.id_imovel}`"
                            style="float: inline-end;" class="text-danger">
                            <i class="fa fa-trash"></i>
                        </a>

                        <!-- Componente Modal de Exclusão -->
                        <DeleteModal v-for="item in imoveisOnCurrentPage" :key="item.id_imovel"
                            :modalId="`deleteModal${item.id_imovel}`" :itemName="'imóvel'" :backdrop="'static'"
                            :itemId="item.id_imovel" @delete-item="handledDelete(item.id_imovel)" />

                        <h5 class="text-info">
                            <strong>{{ formatCurrency(item.preco.preco_imovel) }}</strong><a data-bs-toggle="modal"
                                :data-bs-target="`#modalImovel${item.id_imovel}`" style="float: inline-end"
                                class="text-info"><i class="fa fa-eye"></i></a>
                        </h5>
                        <h5 class="text-dark">
                            <i class="fa fa-user"></i>
                            <small>
                                {{ item.usuario.nome }} {{ item.usuario.sobrenome }}</small>
                        </h5>
                        <h5 class="text-dark">
                                ...
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        <button class="nav-link" id="nav-comentario-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="nav-comentario" aria-selected="false">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-3">
                                                            <h6 style="font-size: 12px">
                                                                <strong>Drive:
                                                                    <a :href="item.complemento.link_drive"
                                                                        target="_blank">{{ item.complemento.link_drive
                                                                        }}</a></strong>
                                                            </h6>

                                                            <h6 style="font-size: 12px">
                                                                <strong>YouTube:
                                                                    <a :href="item.complemento.link_youtube"
