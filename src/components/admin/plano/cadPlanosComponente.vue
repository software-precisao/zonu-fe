  ...
  <div class="card flex-fill w-100">
    <div class="card-header">
      <h5 class="card-title mb-0">
        <i class="fa fa-dollar"></i> Cadastro de Planos
      </h5>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="form-group col-md-3">
            ...
            <input type="text" @input="mascaraValorplano" v-model="valorPlano" class="form-control mt-2" id="nome"
              placeholder="R$ 0,00" />
          </div>

          <div class="form-group col-md-12 mt-3">
            <label for="nome"><small><strong>Faça uma breve descrição sobre seu plano</strong></small></label>
            <textarea rows="4" style="height: 90px" v-model="descricaoPlano" class="form-control mt-2" id="nome"
          ...
          <div class="alert alert-info alert-dismissible fade show" role="alert">
            <strong><i class="fa fa-star"></i> Sugestão zonu</strong> Adicione
            quantidades iguais de itens para cada plano.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>

          <div class="row">
            <div v-for="(item, index) in items" :key="index" class="form-group col-md-7 mt-3">
              <label for="nome"><small><strong>Nome do item do seu plano</strong></small></label>
              <input v-model="item.nome" class="form-control mt-2" :id="'nome-' + index" placeholder="..." />
            </div>
        ...
        <div class="col-lg-4" v-for="item in allPlanos">
          <div class="card shadow-lg mb-4 border-0">
            <div class="card-header border-bottom-0 pt-7 pb-5">
              <div class="d-flex justify-content-center">
                <h1 class="fw-bold">{{ formatCurrency(item.valor_plano) }}</h1>
            ...
            <div class="card-body mx-auto">
              <ul class="list-unstyled mb-4">
                <!-- {{ console.log(JSON.stringify(item.itens_do_plano)) }} -->
...
export default {
  ...
  methods: {
    ...
    mascaraValorplano() {
      ...
      this.valorPlano = valorDecimal.toLocaleString("pt-BR", {
