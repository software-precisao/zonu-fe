      ...
      <div class="container">
        <div class="row">
          <div class="form-group col-md-6">
            <label for="nome"
              ><small><strong>Nome do plano</strong></small></label
            >
            <input
              type="text"
              v-model="nomePlano"
          ...
          <div class="form-group col-md-3">
            <label for="nome"
              ><small><strong>Valor do Plano</strong></small></label
            >
            <input
              type="text"
              @input="mascaraValorplano"
              v-model="valorPlano"
              class="form-control mt-2"
              id="nome"
              placeholder="R$ 0,00"
          ...
          <div class="form-group col-md-12 mt-3">
            <label for="nome"
              ><small
                ><strong
                  >Faça uma breve descrição sobre seu plano</strong
                ></small
              ></label
            >
            <textarea
          ...
          <div class="form-group col-md-12 mt-5 mb-3">
            <label for="nome"
              ><small
                ><strong
                  ><i class="fa fa-plus"></i> Adicione os itens do seu
                  plano</strong
                ></small
              ></label
            >
          ...
          <div class="row">
            ...
            >
              <label for="nome"
                ><small
                  ><strong>Nome do item do seu plano</strong></small
                ></label
              >
              <input
                v-model="item.nome"
