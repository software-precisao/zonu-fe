                ...
                <a class="row" style="text-decoration: none;">
                    ...
                    <div class="col-9" style="margin-left: -10px;">
                        ...
                        <h5 class="text-dark"><small><i class="fa fa-calendar "></i>
                                Atualizado: {{ formatarData(item.updatedAt) }}</small> <i
                                v-for="star in getEstrelas(item.id_imovel)" :key="star"
                                class="text-warning fa fa-star"></i> <span class="text-success"
                        ...
                        <div class="modal-content">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="images-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="images-tab-pane" aria-selected="false"><small>Imagens</small>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="publicar-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="false"><small>Publicação</small>
                                        </button>
                                    </li>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <input type="radio" class="btn-check"
                                                                name="selectCondominio" id="selectCondominio1"
                                                                autocomplete="off" value="Sim"
                                                                v-model="currentImovel.tem_condominio" />
                                                            <label class="btn btn-outline-success"
                                                                :class="{ active: currentImovel.tem_condominio === 'Sim' }"
                                                            ...
                                                            <label class="btn btn-outline-danger"
                                                                :class="{ active: currentImovel.tem_condominio === 'Não' }"
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3" v-if="currentImovel.tem_condominio === 'Sim'">
                                                        ...
                                                        <label v-if="!mostrarSkeleton" for="exampleInputEmail1"
                                                            class="form-label">Condomínio/empreendimento?
                                                            <small class="text-danger">* </small>
                                                            <a href="/novo-condominio" type="button"
                                                                class="ms-2 text-success" style="
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success"
                                                                :class="{ active: currentImovel.info.terreno === 'Plano' }"
                                                            ...
                                                            <input type="radio" class="btn-check" id="btnTerreno2"
                                                                ...
                                                                v-model="currentImovel.info.terreno" />
                                                            <label class="btn btn-outline-success"
                                                                :class="{ active: currentImovel.info.terreno === 'Aclive' }"
                                                            ...
                                                            <input type="radio" class="btn-check" id="btnTerreno3"
                                                                ...
                                                                v-model="currentImovel.info.terreno" />
                                                            <label class="btn btn-outline-success"
                                                                :class="{ active: currentImovel.info.terreno === 'Declive' }"
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="selectAverbado1"
                                                                :class="{ active: currentImovel.info.averbado === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.info.averbado"
                                                                name="selectAverbado" id="selectAverbado2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="selectAverbado2"
                                                                :class="{ active: currentImovel.info.averbado === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success"
                                                                ...
                                                                :class="{ active: currentImovel.info.escriturado === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.info.escriturado"
                                                                name="selectEscritura" id="selectEscritura2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="selectEscritura2"
                                                                :class="{ active: currentImovel.info.escriturado === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="selectEsquina1"
                                                                :class="{ active: currentImovel.info.esquina === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.info.esquina"
                                                                name="selectEsquina" id="selectEsquina2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="selectEsquina2"
                                                                :class="{ active: currentImovel.info.esquina === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="selectMobilia1"
                                                                :class="{ active: currentImovel.info.mobilia === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.info.mobilia"
                                                                name="selectMobilia" id="selectMobilia2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="selectMobilia2"
                                                                :class="{ active: currentImovel.info.mobilia === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" required v-if="!mostrarSkeleton"
                                                            class="form-control" v-model="currentImovel.comodos.suite"
                                                            placeholder="Digite a quantidade" />
                                                    </div>
                                                    <p v-if="msgNullComodos" class="text-danger"><small><i
                                                                class="fa fa-ban"></i>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" required v-if="!mostrarSkeleton"
                                                            class="form-control" v-model="currentImovel.comodos.garagem"
                                                            placeholder="Digite a quantidade" />
                                                    </div>
                                                    <p v-if="msgNullComodos" class="text-danger"><small><i
                                                                class="fa fa-ban"></i>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                            aria-label="Basic radio toggle button group">
                                                            <input v-if="!mostrarSkeleton" type="radio"
                                                                class="btn-check" name="garagemCoberta"
                                                                id="selectGaragemCobertura1" autocomplete="off"
                                                                value="Sim"
                                                                v-model="currentImovel.comodos.garagem_coberta" />
                                                            <label v-if="!mostrarSkeleton"
                                                                class="btn btn-outline-success"
                                                                for="selectGaragemCobertura1"
                                                                :class="{ active: currentImovel.comodos.garagem_coberta === 'Sim' }">Sim</label>

                                                            <input v-if="!mostrarSkeleton" type="radio"
                                                                class="btn-check" value="Não"
                                                                v-model="currentImovel.comodos.garagem_coberta"
                                                            ...
                                                            <label v-if="!mostrarSkeleton"
                                                                ...
                                                                :class="{ active: currentImovel.comodos.garagem_coberta === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                            aria-label="Basic radio toggle button group">
                                                            <input v-if="!mostrarSkeleton" type="radio"
                                                                class="btn-check" name="boxGaragem" id="boxGaragemY"
                                                                autocomplete="off" value="Sim"
                                                                v-model="currentImovel.comodos.garagem_box" />
                                                            <label v-if="!mostrarSkeleton"
                                                                class="btn btn-outline-success" for="boxGaragemY"
                                                                :class="{ active: currentImovel.comodos.garagem_box === 'Sim' }">Sim</label>
                                                            ...
                                                            <label v-if="!mostrarSkeleton"
                                                                class="btn btn-outline-danger" for="boxGaragemN"
                                                                :class="{ active: currentImovel.comodos.garagem_box === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" required v-if="!mostrarSkeleton"
                                                            class="form-control" v-model="currentImovel.comodos.sala_tv"
                                                            placeholder="Digite a quantidade" />
                                                    </div>
                                                    <p v-if="msgNullComodos" class="text-danger"><small><i
                                                                class="fa fa-ban"></i>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" required v-if="!mostrarSkeleton"
                                                            class="form-control" v-model="currentImovel.comodos.lavabo"
                                                            placeholder="Digite a quantidade" />
                                                    </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" required v-if="!mostrarSkeleton"
                                                            class="form-control" v-model="currentImovel.comodos.cozinha"
                                                            placeholder="Digite a quantidade" />
                                                    </div>
                                                    <p v-if="msgNullComodos" class="text-danger"><small><i
                                                                class="fa fa-ban"></i>
                                                ...
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" required v-if="!mostrarSkeleton"
                                                            class="form-control" v-model="currentImovel.comodos.closet"
                                                            placeholder="Digite a quantidade" />
                                                    </div>
                                                    <p v-if="msgNullComodos" class="text-danger"><small><i
                                                                class="fa fa-ban"></i>
                                                ...
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" required v-if="!mostrarSkeleton"
                                                            class="form-control" v-model="currentImovel.comodos.copa"
                                                            placeholder="Digite a quantidade" />
                                                    </div>
                                                    <p v-if="msgNullComodos" class="text-danger"><small><i
                                                                class="fa fa-ban"></i>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        <div v-if="mostrarSkeleton" class="skeleton-label"></div>
                                                        <div v-if="mostrarSkeleton" class="skeleton-input"></div>
                                                        <label v-if="!mostrarSkeleton" for="areaTotal"
                                                            class="form-label">
                                                            Área Total
                                                        </label>
                                                        <div class="input-group">
                                            ...
                                            <div class="row mt-4">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="btnradio1"
                                                                :class="{ active: currentImovel.preco.mostra_preco === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.preco.mostra_preco"
                                                                name="precoNoSite" id="btnradio2" autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="btnradio2"
                                                                :class="{ active: currentImovel.preco.mostra_preco === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            aria-label="Basic radio toggle button group">
                                                            <input type="radio" class="btn-check" name="periodo"
                                                                id="periodo1" autocomplete="off" value="Anual"
                                                                v-model="currentImovel.preco.periodo" />
                                                            <label class="btn btn-outline-success" for="periodo1"
                                                                :class="{ active: currentImovel.preco.periodo === 'Anual' }">Anual</label>

                                                            <input type="radio" class="btn-check" value="Mensal"
                                                                v-model="currentImovel.preco.periodo" name="periodo"
                                                                id="periodo2" autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="periodo2"
                                                                :class="{ active: currentImovel.preco.periodo === 'Mensal' }">Mensal</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="estaFinanciado1"
                                                                :class="{ active: currentImovel.preco.financiado === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.preco.financiado"
                                                                name="estaFinanciado" id="estaFinanciado2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="estaFinanciado2"
                                                                :class="{ active: currentImovel.preco.financiado === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            aria-label="Basic radio toggle button group">
                                                            <input type="radio" class="btn-check"
                                                                name="aceitaFinanciamento" id="aceitaFinanciamento1"
                                                                autocomplete="off" value="Sim"
                                                                v-model="currentImovel.preco.aceita_financiamento" />
                                                            <label class="btn btn-outline-success"
                                                                for="aceitaFinanciamento1"
                                                                :class="{ active: currentImovel.preco.aceita_financiamento === 'Sim' }">Sim</label>
                                                            ...
                                                            <label class="btn btn-outline-danger"
                                                                ...
                                                                :class="{ active: currentImovel.preco.aceita_financiamento === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <input type="radio" class="btn-check" name="mCasaMVida"
                                                                ...
                                                                v-model="currentImovel.preco.minhacasa_minhavida" />
                                                            <label class="btn btn-outline-success" for="mCasaMVida1"
                                                                :class="{ active: currentImovel.preco.minhacasa_minhavida === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.preco.minhacasa_minhavida"
                                                                name="mCasaMVida" id="mCasaMVida2" autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="mCasaMVida2"
                                                                :class="{ active: currentImovel.preco.minhacasa_minhavida === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" required v-if="!mostrarSkeleton"
                                                            class="form-control" v-model="taxasTotal"
                                                            placeholder="R$ 0,00"
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div v-if="!mostrarSkeleton" class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="aceitaPermuta1"
                                                                :class="{ active: currentImovel.preco.aceita_permuta === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.preco.aceita_permuta"
                                                                name="aceitaPermuta" id="aceitaPermuta2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="aceitaPermuta2"
                                                                :class="{ active: currentImovel.preco.aceita_permuta === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="mostrarAndar1"
                                                                :class="{ active: currentImovel.localizacao.mostrar_andar_site === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.localizacao.mostrar_andar_site"
                                                                name="mostrarAndar" id="mostrarAndar2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="mostrarAndar2"
                                                                :class="{ active: currentImovel.localizacao.mostrar_andar_site === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success"
                                                                ...
                                                                :class="{ active: currentImovel.localizacao.mostrar_numero_unidade_site === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.localizacao.mostrar_numero_unidade_site"
                                                                name="mostrarNUnidade" id="mostrarNUnidade2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="mostrarNUnidade2"
                                                                :class="{ active: currentImovel.localizacao.mostrar_numero_unidade_site === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                            aria-label="Basic radio toggle button group">
                                                            <input type="radio" class="btn-check"
                                                                name="mostrarLogradouro" id="mostrarLogradouro1"
                                                                autocomplete="off" value="Sim"
                                                                v-model="currentImovel.localizacao.mostrar_logradouro_site" />
                                                            <label class="btn btn-outline-success"
                                                                for="mostrarLogradouro1"
                                                                :class="{ active: currentImovel.localizacao.mostrar_logradouro_site === 'Sim' }">Sim</label>
                                                            ...
                                                            <label class="btn btn-outline-danger"
                                                                ...
                                                                :class="{ active: currentImovel.localizacao.mostrar_logradouro_site === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="mostrarBairro1"
                                                                :class="{ active: currentImovel.localizacao.mostrar_bairro_site === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.localizacao.mostrar_bairro_site"
                                                                name="mostrarBairro" id="mostrarBairro2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="mostrarBairro2"
                                                                :class="{ active: currentImovel.localizacao.mostrar_bairro_site === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                            aria-label="Basic radio toggle button group">
                                                            <input type="radio" class="btn-check"
                                                                name="mostrarComplemento" id="mostrarComplemento1"
                                                                autocomplete="off" value="Sim"
                                                                v-model="currentImovel.localizacao.mostrar_complemento_site" />
                                                            <label class="btn btn-outline-success"
                                                                for="mostrarComplemento1"
                                                                :class="{ active: currentImovel.localizacao.mostrar_complemento_site === 'Sim' }">Sim</label>
                                                            ...
                                                            <label class="btn btn-outline-danger"
                                                                ...
                                                                :class="{ active: currentImovel.localizacao.mostrar_complemento_site === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="mostrarNumero1"
                                                                :class="{ active: currentImovel.localizacao.mostrar_numero_site === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="currentImovel.localizacao.mostrar_numero_site"
                                                                name="mostrarNumero" id="mostrarNumero2"
                                                                autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="mostrarNumero2"
                                                                :class="{ active: currentImovel.localizacao.mostrar_numero_site === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <label class="btn btn-outline-success" for="mostrarNCondo1"
                                                                :class="{ active: currentImovel.localizacao.mostrar_nome_condominio_site === 'Sim' }">Sim</label>

                                                            <input type="radio" class="btn-check" value="Não"
                                                                v-model="mostrarNCondo" name="mostrarNCondo"
                                                                id="mostrarNCondo2" autocomplete="off" />
                                                            <label class="btn btn-outline-danger" for="mostrarNCondo2"
                                                                :class="{ active: currentImovel.localizacao.mostrar_nome_condominio_site === 'Não' }">Não</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="btn-group" role="group"
                                                                    aria-label="Basic radio toggle button group">
                                                                    <input type="radio" class="btn-check"
                                                                        name="selectMapSite" id="selectMapSite1"
                                                                        autocomplete="off" value="Sim"
                                                                        v-model="selectMapSite" />
                                                                    <label class="btn btn-outline-success"
                                                                        for="selectMapSite1"
                                                                        :class="{ active: currentImovel.localizacao.mostrar_mapa_site === 'Sim' }">Sim</label>
                                                                    ...
                                                                    <label class="btn btn-outline-danger"
                                                                        for="selectMapSite2"
                                                                        :class="{ active: currentImovel.localizacao.mostrar_mapa_site === 'Não' }">Não</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-check"
                                                        ...
                                                        <input v-if="!mostrarSkeleton" class="form-check-input"
                                                            v-model="currentImovel.proximidades[proximidade.id_proximidade]"
                                                            type="checkbox"
                                                            ...
                                                            <div class="col" v-if="images.length < maxImages">
                                                                <div class="card bg-transparent border-0">
                                                                    <div class="preview-photo-prato area-photo-prato">
                                                                        ...
                                                                        <div v-if="success"><i class="fa fa-check"></i>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <label class="btn btn-outline-success" for="selectImovelSite1"
                                                            :class="{ active: currentImovel.publicacao.mostrar_imovel_publi === 'Sim' }">Sim</label>

                                                        <input type="radio" class="btn-check" value="Não"
                                                            v-model="selectImovelSite" name="selectImovelSite"
                                                            id="selectImovelSite2" autocomplete="off" />
                                                        <label class="btn btn-outline-danger" for="selectImovelSite2"
                                                            :class="{ active: currentImovel.publicacao.mostrar_imovel_publi === 'Não' }">Não</label>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-8">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" required v-if="!mostrarSkeleton"
                                                                class="form-control"
                                                                v-model="currentImovel.publicacao.tarja_imovel_site_publi"
                                                    ...
                                                    <div class="col-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="color" v-if="!mostrarSkeleton"
                                                                v-model="currentImovel.publicacao.cor_tarja_publi"
                                                                class="form-control" id="exampleColorInput"
                                                                value="#563d7c" title="Escolha a cor" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-warning" :disabled="autenticando"
                                    @click="handleFinishEdit(item.id_imovel)">Salvar alterações &nbsp;<i
...
export default {
    ...
    methods: {
        ...
        handleFinishEdit(id) {
            ...
            let codRef = this.currentImovel.cod_referencia;
            let tipoImovel = this.currentImovel.tipo_imovel;
            let perfilImovel = this.currentImovel.perfil_imovel;
            let situacaoImovel = this.currentImovel.situacao_imovel;
            let anoImovel = this.currentImovel.ano_construcao;
            let incorporacao = this.currentImovel.incorporacao;
            let posicaoSolar = this.currentImovel.posicao_solar;
            let selectTerreno = this.currentImovel.terreno;
            let proximoMar = this.currentImovel.proximo_mar;
            let selectAverbado = this.currentImovel.averbado;
            let selectEscritura = this.currentImovel.escriturado;
            let selectEsquina = this.currentImovel.esquina;
            let selectMobilia = this.currentImovel.mobilia;

            let dormitorio = this.currentImovel.dormitorio;
            let suite = this.currentImovel.suite;
            let banheiro = this.currentImovel.banheiro;
            let garagem = this.currentImovel.garagem;
            let selectGaragemCobertura = this.currentImovel.garagem_coberta;
            let selectBoxGaragem = this.currentImovel.garagem_box;
            let salaTv = this.currentImovel.sala_tv;
            let salaJantar = this.currentImovel.sala_jantar;
            let lavabo = this.currentImovel.lavabo;
            let areaServico = this.currentImovel.area_servico;
            let cozinha = this.currentImovel.cozinha;
            let closet = this.currentImovel.closet;
            let escritorio = this.currentImovel.escritorio;
            let depEmpregada = this.currentImovel.casa_empregada;
            let copa = this.currentImovel.copa;

            let tipoNegocio = this.currentImovel.tipo_negocio;
            let precoImovel = this.precoImovel;
            let precoNoSite = this.currentImovel.mostra_preco;
            let textoLugarPreco = this.currentImovel.texto_preco_opcao;
            let precoIptu = this.precoIptu;
            let periodoIptu = this.currentImovel.periodo_iptu;
            let precoCondominio = this.precoCondominio;
            let estaFinanciado = this.currentImovel.financiado;
            let aceitaFinanciamento = this.currentImovel.aceita_financiamento;
            let mCasaMVida = this.currentImovel.minhacasa_minhavida;
            let taxasTotal = this.taxasTotal;
            let taxasDescricao = this.currentImovel.descricao_taxas;
            let aceitaPermuta = this.currentImovel.aceita_permuta;
            let permutaDescricao = this.currentImovel.descricao_permuta;
            ...
            let nLogradouro = this.currentImovel.numero;
            let complemento = this.currentImovel.complemento;
            let idUnidade = this.currentImovel.numero_unidade;
            let selectAndar = this.currentImovel.andar;
            let undPorAndar = this.currentImovel.unidade_por_andar;
            let totalAndares = this.currentImovel.total_andar;
            let totalTorres = this.currentImovel.total_torres;
            let mostrarAndar = this.currentImovel.mostrar_andar_site;
            let mostrarNUnidade = this.currentImovel.mostrar_numero_unidade_site;
            let mostrarLogradouro = this.currentImovel.mostrar_logradouro_site;
            let mostrarBairro = this.currentImovel.mostrar_bairro_site;
            let mostrarComplemento = this.currentImovel.mostrar_complemento_site;
            let mostrarNumero = this.currentImovel.mostrar_numero_site;
            let mostrarNCondo = this.currentImovel.mostrar_nome_condominio_site;
            let selectMapSite = this.currentImovel.mostrar_mapa_site;

            let titleImovel = this.currentImovel.titulo;
            let descricaoImovel = this.currentImovel.descricao;

            let urlYT = this.currentImovel.link_youtube;
            let url360 = this.currentImovel.link_apresentacao;
            let link_drive = this.currentImovel.link_drive;

            let caracteristicas = this.getCombinedSelectedCaracteristicasIDs();
            let proximidades = this.getCombinedSelectedProximidadesIDs();

            let selectImovelSite = this.currentImovel.mostrar_imovel_publi;
            let textoTarja = this.currentImovel.tarja_imovel_site_publi;
            let corTarja = this.currentImovel.cor_tarja_publi;

            let selecteCond = this.currentImovel.tem_condominio;
            let idcondominio = selecteCond === "Sim" ? this.currentImovel.id_condominio : 1;
            ...
            let valorImovelLimpo = precoImovel.replace("R$", "").trim().replace(/\./g, "").replace(",", ".");
            let valorImovelFloat = parseFloat(valorImovelLimpo);
            let areaConstruidaFloat = parseFloat(this.areaConstruida.replace(/\./g, "").replace(",", "."));
            let valorMetroQuadrado = (valorImovelFloat / areaConstruidaFloat).toFixed(2);
            ...
            formData.append("preco_iptu", parseFloat(precoIptu.replace(/\./g, "").replace(",", ".")));
            formData.append("periodo_iptu", periodoIptu);
            formData.append("preco_condominio", parseFloat(precoCondominio.replace(/\./g, "").replace(",", ".")));
            ...
            formData.append("total_mensal_taxas", parseFloat(taxasTotal.replace(/\./g, "").replace(",", ".")));
            ...
            api.editarImovel(id, formData).then((res) => {
                if (res.status === 200) {
