    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
                        <h5 class="card-title">Meus Tickes <small class="text-warning">Aberto</small></h5>
                    </div>
                    <div class="col-auto">
                        <div class="stat text-primary">
                ...
                <div class="mb-0">
                    <span class="text-muted"><small> <i class="fa fa-smile-o"></i> Sem problemas graves</small></span>
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col mt-0">
                        <h5 class="card-title">Meus Tickets <small class="text-success">Resolvidos</small> </h5>
                    </div>
                    <div class="col-auto">
                        <div class="stat text-primary">
